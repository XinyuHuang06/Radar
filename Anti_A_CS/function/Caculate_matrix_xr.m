function [A1,BT1,Tar_seq] = Caculate_matrix_xr(N, FNr,xr_in, br, cr, omega_alpha_1, rho_0, rho_1, lambda_0, lambda_1, h, vartheta, Taf_1, Taf_2, chi_matrix, flag_Sparse)
    if flag_Sparse
        % % A1
